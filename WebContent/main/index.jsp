...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark pixed-top">
		<a class="navbar-brand" href="index.html"> <img
			src="${pageContext.request.contextPath }/image/L_gnd.png"
			alt="GnD_Logo" />
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="#">아티스트</a></li>
				<li class="nav-item"><a class="nav-link" href="#">뉴스레터구독</a></li>
			</ul>
		</div>
		<div class="social-icon">
			<a href="https://www.facebook.com/warnermusickorea/"> <i
				class="fab fa-facebook-f"></i>
			</a> <a href="https://www.instagram.com/warnermusickorea/"> <i
				class="fab fa-youtube"></i>
			</a> <a href="https://www.youtube.com/user/WMK2011"> <i
				class="fab fa-instagram"></i>
			</a> <a href="https://twitter.com/Warner_Music_Kr"> <i
				...
				<div class="col-3">
					<div class="card" style="width: 18rem;">
						...
						<div class="card-body">
							...
							<p class="card-text">2019 국내 음원차트 1위, 앤-마리 새 싱글 ‘To Be Young’
								7월 17일 정오 발매 ‘국민 팝스타’ 앤-마리(Anne-Marie)가 7월 17일 정오에 새 싱글 ‘To Be
								Young’을 발매한다....</p>
