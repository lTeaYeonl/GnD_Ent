...
public class InformDto {
	...
	public String getInf_pwd2() {
		return inf_pwd2;
	}
	public void setInf_pwd2(String inf_pwd2) {
		this.inf_pwd2 = inf_pwd2;
	}
	...
	public int getInf_phone() {
		return inf_phone;
	}
	public void setInf_phone(int inf_phone) {
	...
	public String getInf_address2() {
		return inf_address2;
	}
	public void setInf_address2(String inf_address2) {
		this.inf_address2 = inf_address2;
	}
	...
	public InformDto(String inf_name, String inf_email, String inf_pwd, String inf_pwd2, String inf_nt, String inf_sel,
			String inf_sex, String inf_bday, int inf_height, int inf_weight, int inf_phone, String inf_job,
			String inf_sns, String inf_address, String inf_address2, String inf_lan, String inf_hobby, String inf_spec,
			String inf_intro) {
		super();
		this.inf_name = inf_name;
		this.inf_email = inf_email;
